...
VALUES 
    (3, N'Hoa Lily', N'../anhhoa/hoa3.jpg', 50000, 0, 5, 0, 5, 0),
    (7, N'Hoa Sen', N'../anhhoa/hoa4.jpg', 75000, 0, 8, 0, 8, 0),
    (6, N'Hoa Đồng Tiền', N'../anhhoa/hoa7.jpg', 60000, 0, 3, 0, 6, 0),
    (8, N'Hoa Dã Quỳ', N'../anhhoa/hoa9.jpg', 45000, 0, 6, 0, 10, 0),
    (10, N'Hoa Lan', N'../anhhoa/hoa11.jpg', 90000, 0, 10, 0, 15, 0),
    (5, N'Hoa Huệ', N'../anhhoa/hoa12.jpg', 80000, 0, 4, 0, 20, 0),
    (3, N'Hoa Mai', N'../anhhoa/hoa13.jpg', 55000, 0, 7, 0, 25, 0),
    (10, N'Hoa Thiên Điểu', N'../anhhoa/hoa14.jpg', 70000, 0, 9, 0, 30, 0),
    (8, N'Hoa Dã Quỳ Tím', N'../anhhoa/hoa15.jpg', 40000, 0, 2, 0, 35, 0),
    (10, N'Hoa Hồng Đỏ', N'../anhhoa/hoa16.jpg', 95000, 0, 5, 0, 40, 0);
...
--tim kiem hoa don
go
create PROCEDURE [dbo].[sp_hoadon_search] (@page_index  INT, 
                                       @page_size   INT,
									   @ten_khach Nvarchar(50),
									   @dia_chi Nvarchar(250),
									   @trang_thai bit,
